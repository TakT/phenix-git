var ChangeFloor = {
	...
	elS: {
		...
		tourCompas: jQuery('#change_floor').find('.tour3D__compass'),
		tourViewTurn: jQuery('#change_floor').find('.tour3D__turn a'),
	...
	init: function(userConfig) {
		...
		this.paper = ScaleRaphael('change_floor', this.sizeCanvas.width, this.sizeCanvas.height);
